...
public class House4Structure extends MichrosiaElements.ModElement {
	public House4Structure(MichrosiaElements instance) {
		super(instance, 96);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1500) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("michrosia", "house4"));
						if (template == null)
							return false;
