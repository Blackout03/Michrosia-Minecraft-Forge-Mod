...
public class House2Structure extends MichrosiaElements.ModElement {
	public House2Structure(MichrosiaElements instance) {
		super(instance, 94);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1500) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("michrosia", "house2"));
						if (template == null)
							return false;
