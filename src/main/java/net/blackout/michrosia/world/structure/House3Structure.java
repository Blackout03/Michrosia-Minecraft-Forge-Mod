...
public class House3Structure extends MichrosiaElements.ModElement {
	public House3Structure(MichrosiaElements instance) {
		super(instance, 95);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 300) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("michrosia", "house3"));
						if (template == null)
							return false;
