...
package net.blackout.michrosia.world.structure;
...
public class House1Structure extends MichrosiaElements.ModElement {
	public House1Structure(MichrosiaElements instance) {
		super(instance, 93);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1500) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("michrosia", "house1"));
						if (template == null)
							return false;
