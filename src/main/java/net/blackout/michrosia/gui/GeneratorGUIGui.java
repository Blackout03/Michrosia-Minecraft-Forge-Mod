...
package net.blackout.michrosia.gui;
...
public class GeneratorGUIGui extends MichrosiaModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public GeneratorGUIGui(MichrosiaModElements instance) {
		super(instance, 132);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("michrosia:textures/generator_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Plutonium Generator", 6, 7, -12829636);
			...
			}.getEnergyStored(new BlockPos((int) x, (int) y, (int) z))) + "", 78, 43, -12829636);
		}
