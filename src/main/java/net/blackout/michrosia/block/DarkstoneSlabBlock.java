...
public class DarkstoneSlabBlock extends MichrosiaModElements.ModElement {
	@ObjectHolder("michrosia:darkstoneslab")
	public static final Block block = null;
	public DarkstoneSlabBlock(MichrosiaModElements instance) {
		super(instance, 17);
	}
