...
public class EvenExtraDarkstoneBlock extends MichrosiaModElements.ModElement {
	@ObjectHolder("michrosia:even_extra_darkstone")
	public static final Block block = null;
	public EvenExtraDarkstoneBlock(MichrosiaModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("even_extra_darkstone");
		}
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, new OreFeature(OreFeatureConfig::deserialize) {
				...
				public boolean place(IWorld world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("even_extra_darkstone", "even_extra_darkstone", blockAt -> {
