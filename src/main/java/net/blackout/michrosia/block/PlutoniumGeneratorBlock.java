...
import net.blackout.michrosia.procedures.PlutoniumGeneratorUpdateTickProcedure;
import net.blackout.michrosia.itemgroup.MichrosiaTabItemGroup;
import net.blackout.michrosia.gui.GeneratorGUIGui;
...
public class PlutoniumGeneratorBlock extends MichrosiaModElements.ModElement {
	@ObjectHolder("michrosia:plutonium_generator")
	public static final Block block = null;
	@ObjectHolder("michrosia:plutonium_generator")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public PlutoniumGeneratorBlock(MichrosiaModElements instance) {
		super(instance, 133);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("plutonium_generator"));
	}
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("plutonium_generator");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				PlutoniumGeneratorUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Plutonium Generator");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("plutonium_generator");
		}
