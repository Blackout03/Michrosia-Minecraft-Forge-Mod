...
public class MichrosiaGrassShort1Block extends MichrosiaModElements.ModElement {
	@ObjectHolder("michrosia:michrosiagrassshort1")
	public static final Block block = null;
	public MichrosiaGrassShort1Block(MichrosiaModElements instance) {
		super(instance, 100);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("michrosiagrassshort1");
		}
