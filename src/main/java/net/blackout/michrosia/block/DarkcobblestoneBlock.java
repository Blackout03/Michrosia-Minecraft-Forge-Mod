...
public class DarkcobblestoneBlock extends MichrosiaModElements.ModElement {
	@ObjectHolder("michrosia:darkcobblestone")
	public static final Block block = null;
	public DarkcobblestoneBlock(MichrosiaModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkcobblestone");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("darkcobblestone", "darkcobblestone", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == DarkstoneBlock.block.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 16)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(32, 0, 0, 140))));
		}
	}
}
