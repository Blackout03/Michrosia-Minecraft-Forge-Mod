...
public class DarkstoneStairsBlock extends MichrosiaModElements.ModElement {
	@ObjectHolder("michrosia:darkstonestairs")
	public static final Block block = null;
	public DarkstoneStairsBlock(MichrosiaModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("darkstonestairs");
		}
