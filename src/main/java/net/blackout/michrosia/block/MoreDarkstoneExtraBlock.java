...
public class MoreDarkstoneExtraBlock extends MichrosiaModElements.ModElement {
	@ObjectHolder("michrosia:more_darkstone_extra")
	public static final Block block = null;
	public MoreDarkstoneExtraBlock(MichrosiaModElements instance) {
		super(instance, 128);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("more_darkstone_extra");
		}
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, new OreFeature(OreFeatureConfig::deserialize) {
				...
				public boolean place(IWorld world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("more_darkstone_extra", "more_darkstone_extra", blockAt -> {
