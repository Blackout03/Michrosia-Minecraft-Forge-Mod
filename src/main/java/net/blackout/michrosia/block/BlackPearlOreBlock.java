...
import net.blackout.michrosia.procedures.BlackPearlOreBlockDestroyedByPlayerProcedure;
...
public class BlackPearlOreBlock extends MichrosiaModElements.ModElement {
	@ObjectHolder("michrosia:black_pearl_ore")
	public static final Block block = null;
	public BlackPearlOreBlock(MichrosiaModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_pearl_ore");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				BlackPearlOreBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("black_pearl_ore", "black_pearl_ore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.END_STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 12)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(32, 0, 0, 255))));
		}
	}
}
