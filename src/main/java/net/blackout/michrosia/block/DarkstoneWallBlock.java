...
public class DarkstoneWallBlock extends MichrosiaModElements.ModElement {
	@ObjectHolder("michrosia:darkstonewall")
	public static final Block block = null;
	public DarkstoneWallBlock(MichrosiaModElements instance) {
		super(instance, 18);
	}
