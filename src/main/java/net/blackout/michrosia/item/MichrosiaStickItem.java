...
public class MichrosiaStickItem extends MichrosiaElements.ModElement {
	@ObjectHolder("michrosia:michrosiastick")
	public static final Item block = null;
	public MichrosiaStickItem(MichrosiaElements instance) {
		super(instance, 115);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("michrosiastick");
		}
