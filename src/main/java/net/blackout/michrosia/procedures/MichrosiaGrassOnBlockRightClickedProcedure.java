...
public class MichrosiaGrassOnBlockRightClickedProcedure extends MichrosiaModElements.ModElement {
	public MichrosiaGrassOnBlockRightClickedProcedure(MichrosiaModElements instance) {
		super(instance, 60);
