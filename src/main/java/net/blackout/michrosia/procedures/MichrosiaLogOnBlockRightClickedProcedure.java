...
public class MichrosiaLogOnBlockRightClickedProcedure extends MichrosiaModElements.ModElement {
	public MichrosiaLogOnBlockRightClickedProcedure(MichrosiaModElements instance) {
		super(instance, 53);
