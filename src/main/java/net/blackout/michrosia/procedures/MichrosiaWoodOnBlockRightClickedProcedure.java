...
public class MichrosiaWoodOnBlockRightClickedProcedure extends MichrosiaModElements.ModElement {
	public MichrosiaWoodOnBlockRightClickedProcedure(MichrosiaModElements instance) {
		super(instance, 54);
