...
package net.mcreator.michrosia.gui;
...
import net.mcreator.michrosia.Michrosia;
...
public class ReprocessorGUIGui extends MichrosiaElements.ModElement {
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("reprocessorgui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("michrosia:textures/reprocessorgui.png");
		@Override
