...
package net.mcreator.michrosia.item;
...
import net.mcreator.michrosia.procedures.PlutoniumIngotMobIsHitWithItemProcedure;
import net.mcreator.michrosia.procedures.PlutoniumIngotItemInInventoryTickProcedure;
...
public class PlutoniumIngotItem extends MichrosiaElements.ModElement {
	@ObjectHolder("michrosia:plutoniumingot")
	public static final Item block = null;
	public PlutoniumIngotItem(MichrosiaElements instance) {
		super(instance, 16);
	}
