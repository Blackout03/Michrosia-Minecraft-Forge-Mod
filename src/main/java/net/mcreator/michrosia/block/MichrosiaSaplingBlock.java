...
import net.mcreator.michrosia.procedures.MichrosiaSaplingUpdateTickProcedure;
import net.mcreator.michrosia.procedures.MichrosiaSaplingOnBlockRightClickedProcedure;
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, World world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				MichrosiaSaplingUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
