...
public class DarkcobblestoneBlock extends MichrosiaElements.ModElement {
	@ObjectHolder("michrosia:darkcobblestone")
	public static final Block block = null;
	public DarkcobblestoneBlock(MichrosiaElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.5f, 30f).lightValue(0).harvestLevel(1)
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("darkcobblestone", "darkcobblestone", blockAt -> {
